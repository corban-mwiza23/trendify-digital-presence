    ...
    <footer className="bg-tech-blue text-white">
      <div className="container-custom py-12 px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">TechTrends Ltd</h3>
            <p className="text-gray-300 mb-4">
              Leading electronic gadgets provider in Kigali City. Quality products and excellent service since 2010.
            </p>
            <div className="flex space-x-4">
              {/* Social Media Icons (placeholder) */}
              <a href="#" className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center hover:bg-tech-accent transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="w-5 h-5 mr-2 mt-0.5 text-tech-accent" />
                <span>KG 123 Street, Kigali City, Rwanda</span>
              </li>
              <li className="flex items-center">
                <Phone className="w-5 h-5 mr-2 text-tech-accent" />
                <a href="tel:+250700000000" className="hover:text-tech-accent transition-colors">
                  +250 700 000 000
                </a>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 mr-2 text-tech-accent" />
